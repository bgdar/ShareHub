...
class fileManagement(models.Model):
    ...
    document_file = models.FileField(upload_to="file/documents/", blank=True, null=True)
    arsip_file = models.FileField(upload_to="file/arsip", blank=True, null=True)
    executable_file = models.FileField(
        upload_to="file/executable", blank=True, null=True
    )
    image_file = models.FileField(upload_to="file/image", blank=True, null=True)
